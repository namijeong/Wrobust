...
pdf(file="Fig3.pdf", width=12.8, height=7.4, paper = "special", encoding = "TeXtext.enc")
...
legend (1e-05, 2.9,lty=c(1,2,3,1) ,col=c("red","Orange red","pale violet red","Lime green"),
        legend=c("MLE", "WP","seki","e"), bty="n" ,lwd = 2, cex =1)
legend (1e-03, 2.9,lty=c(3,1,3,4) ,col=c( "Forest green","dark blue","navy blue","slate blue"),
...
legend (1e-05, 0.5, lty=c(1,2,3,1) ,col=c("red","Orange red","pale violet red","Lime green"),
        legend=c("MLE", "WP","seki","e"), bty="n"  ,lwd = 2, cex =1)
legend (1e-03, 0.5, lty=c(3,1,3,4) ,col=c( "Forest green","dark blue","navy blue","slate blue"),
        legend=c("W.med","med1","med2","med3"), bty="n"  ,lwd = 2, cex =1)
