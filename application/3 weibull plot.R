...
par( mfrow=c(1,3), mar=c(5,5,3,1), omi=c(0,0,0,0), cex=0.5,mex=0.5 )
#==============================================================================
xlim = c(9,14)
...
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.mle(data,0)$shape,scale=weibull.mle(data,0)$scale))), lty=1, col ="dark gray" ,lwd = 2)
...
xxx = seq(min(X),max(X), l=100)
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.mle(X,0)$shape,scale=weibull.mle(X,0)$scale))), lty=1, col ="dark gray" ,lwd = 2)
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.wp(X)$shape,scale=weibull.wp(X)$scale))), lty=2, col ="Dim Gray" ,lwd = 2)
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.med1(X)$shape,scale=weibull.med1(X)$scale))), lty=3, col ="Pale violet red2" ,lwd = 2)
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.med2(X)$shape,scale=weibull.med2(X)$scale))), lty=4, col ="dark Orchid2" ,lwd = 2)
lines(log(xxx), log(-log(Sweibull( xxx, shape=weibull.med3(X)$shape,scale=weibull.med3(X)$scale))), lty=5, col ="slate blue" ,lwd = 2)
