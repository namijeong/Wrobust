...
#    Noise 
    ...
    ####   Change inliner noise
    ##   data[1] = data[1]/10     ## slope method is sensitive to left outlier (close to zero).
       data[1] = data[1]/1000   ## slope method is sensitive to left outlier (close to zero).
