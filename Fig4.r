...
par( mfrow=c(1,3), mar=c(6.0,4.8,3,1), omi=c(0,0,0,0), cex=1.2 ,mex=0.75 )
#==============================================================================
xlim = c(9,14)
#xlim = c(0,5)
#ylim = range( log(-log(Fall) ) )
plot(  log(data.sort),  log(-log(1-Fall)), main = "Weibull Probability", pch=16, xlim=xlim,
       xlab="log(t)", ylab="log[-log(1-F(t))]", lwd = 1, cex =1.5, sub="(a)" )
...
legend (11.5, -2.0, lty=c(1,2,1,3,4) ,col=c("red","orange red","dark blue","navy blue","slate blue"),legend=c("MLE", "WP","med1","med2","med3"), bty="n",lwd = 2, cex =1.2)
...
plot(  log(data.sort),  log(-log(1-Fall)), main = "Weibull Probability", pch=16, xlim=xlim,
       xlab="log(t)", ylab="log[-log(1-F(t))]", lwd = 1, cex =1.5, sub="(b)" )
...
plot(  log(data.sort),  log(-log(1-Fall)), main = "Weibull Probability", pch=16,xlim=xlim,  
       xlab="log(t)",  ylab="log[-log(1-F(t))]",  lwd = 1, cex =1.5 , sub="(c)" )
